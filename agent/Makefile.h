...
LIB_LAPACK = /usr/lib/x86_64-linux-gnu/lapack/liblapack.so /usr/lib/x86_64-linux-gnu/blas/libblas.so
...
FFLAGS_HDF5 = -I/usr/include/hdf5/serial
F90FLAGS = $(FFLAGS_HDF5) -ffree-line-length-none
